  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center pointer-events-none p-4">
      ...
      >
        ...
        {achievement.reward && (
          <div className="mt-6 flex items-center gap-3 bg-black/20 rounded-full px-6 py-2 shadow-inner border border-white/10">
            <span className="text-3xl font-black text-yellow-300 drop-shadow-md">+{achievement.reward}</span>
