      ...
      <div className="mx-auto max-w-lg">
        ...
        <div className="panel space-y-5">
          ...
          <div>
            ...
            <div className="mb-6 flex flex-col items-center justify-center animate-in zoom-in slide-in-from-top-2 mt-4">
              <div className="relative group">
                <Avatar id={avatarId || "a1"} size={96} ring="var(--primary)" frameThemeId={frameThemeId} />
