              ...
              <div className="grid gap-4 md:grid-cols-2 pt-2">
                <div className="bg-amber-500/10 border border-amber-500/20 p-5 rounded-2xl">
                  ...
                  <ul className="text-sm text-amber-200/80 space-y-2 list-disc list-inside leading-relaxed">
                    ...
                    <li><strong>في حال التعادل في النقاط (كسر التعادل):</strong> يتم تحديد الفائز وفق التسلسل التالي:
                      <ol className="list-decimal list-inside mt-1 pr-3 space-y-1 text-amber-200">
                        <li>الأفضلية للاعب الذي <strong>أكل قطع الخصم عدد مرات أكبر</strong> في السلسلة.</li>
                        <li>إذا استمر التعادل، الأفضلية للاعب الذي <strong>تم أكل قطعه عدد مرات أقل</strong>.</li>
                        <li>إذا تعادلا في ذلك أيضاً، تحسم الأفضلية للاعب صاحب المركز الأفضل في <strong>المباراة الخامسة والأخيرة</strong>.</li>
                      </ol>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-purple-500/10 border border-purple-500/20 p-5 rounded-2xl">
                  ...
                  <ul className="text-sm text-purple-200/80 space-y-2 list-disc list-inside leading-relaxed">
                    ...
                    <li><strong>في حال التعادل في النقاط:</strong> إذا تساوى لاعبان أو أكثر في نفس عدد النقاط الإجمالية، تكون الأسبقية في الترتيب بناءً على <strong>نسبة الفوز بالمباريات (Win Rate)</strong> الخاصة باللاعب (وإذا تعادلا، فالأسبقية للأكثر عدداً في الانتصارات).</li>
